    ...
    <div className="py-10 relative h-[700px]">
      ...
      <div className="flex flex-col items-center absolute top-0 left-0 w-full h-full bg-black/80 md:bg-transparent  md:bg-gradient-to-r from-black/30 via-black/90 to-black/30">
        ...
        <div className="container flex-1 flex flex-col justify-center items-center gap-5 z-50">
          ...
          <Link
            href="/schedule"
            className="bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold text-base md:text-lg py-2 px-4 rounded-md hover:from-green-600 hover:to-green-700"
          >
            Shedule NOW
          </Link>
        </div>
